import {Anchor, AppShell, Button, Center, Stack, Text} from "@mantine/core";
        ...
        <AppShell.Footer p={'xs'}>
            <Center w={'100%'}>
                <Stack gap={'sm'}>
                    ...
                    <Button component={'a'} target={'_blank'} href={'https://buymeacoffee.com/ouisihai2'}
                            size={'compact-sm'} color={'yellow'} leftSection={<IconCoffee/>}>Buy me a coffee</Button>
                </Stack>
